...
app.get('/Devops', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  HTC Global Services!!! <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
		...
		'technology': 'DevOps',
		'contact' : '+91-785456435344',
		'email': 'adhiyaman.kamaraj@htcinc.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('https://eportal.htcindia.com/main.php');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/Devops");
      })
